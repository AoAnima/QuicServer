...
func ПодключитьсяКСерверуДляОтправкиСообщений(каналОтправкиОтветов chan interface{}, адрес string, порт string) {
	caCert, err := os.ReadFile("cert/ca.crt")
...
func ОтправитьОтветНаЗапрос(сервер *tls.Conn, каналОтправкиОтветов chan interface{}) {
