...
func (клиент Клиент) Соединиться(сервер *СхемаСервера, сообщениеРегистрации Сообщение, ОбработчикОтветаРегистрации func(сообщение Сообщение), ОбработчикЗапросовСервера func(поток quic.Stream, сообщение Сообщение)) {
	...
	// сообщениеБинарное, err := Кодировать(сообщениеРегистрации)
	// поток.Write(сообщениеБинарное)
