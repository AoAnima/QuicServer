...
type ОтветСервиса struct {
	...
	ИмяШаблона      ИмяШаблона // если имя шаблона для html ренндеринга не задано то берём имя сервиса
	ТипОтвета       ТипОтвета
