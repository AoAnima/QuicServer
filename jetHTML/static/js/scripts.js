...
`,
    ...
    <div class="строка">       
            <button type="button" onclick='добавитьБлок(event, {&#34;имяШаблона&#34;:&#34;${данныеШаблона.имяШаблона}&#34;,&#34;функции&#34;:[&#34;пересчитатьОчередь&#34;],&#34;УИД&#34;:&#34;${данныеШаблона.УИД}&#34;} )' class="кнопка с-иконкой основной"> 
                <i class="fas fa-plus p-1"></i>
            </button>          
