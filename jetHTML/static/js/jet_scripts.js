...
{&#34;УИД&#34;:&#34;${данныеШаблона.УИД}&#34;,&#34;имяШаблона&#34;:&#34;${данныеШаблона.имяШаблона}&#34;}
    <div class="field control has-addons">
        <div class="control ">

            <button onclick='добавитьБлок(event, {&#34;имяШаблона&#34;:&#34;${данныеШаблона.имяШаблона}&#34;,&#34;УИД&#34;:&#34;${данныеШаблона.УИД}&#34;} )' class="button  is-primary control"> 
                <i class="fas fa-plus p-1"></i>
            </button>
                    </div>
        <div class="control ">
            <button onclick='удалитьБлок(event, {&#34;имяШаблона&#34;:&#34;${данныеШаблона.имяШаблона}&#34;,&#34;УИД&#34;:&#34;${данныеШаблона.УИД}&#34;} )' class="button  is-danger control">
...
{&#34;имяШаблона&#34;:&#34;${данныеШаблона.имяШаблона}&#34;,&#34;очередь&#34;:&#34;${данныеШаблона.очередь+1}&#34;,&#34;УИД&#34;:&#34;${данныеШаблона.УИД}&#34;}
    <div class="field control has-addons">
        <div class="control ">

            <button onclick='добавитьБлок(event, {&#34;имяШаблона&#34;:&#34;${данныеШаблона.имяШаблона}&#34;,&#34;очередь&#34;:&#34;${данныеШаблона.очередь+1}&#34;,&#34;УИД&#34;:&#34;${данныеШаблона.УИД}&#34;} )' class="button  is-primary control"> 
                <i class="fas fa-plus p-1"></i>
            </button>
                    </div>
        <div class="control ">
            <button onclick='удалитьБлок(event, {&#34;очередь&#34;:&#34;${данныеШаблона.очередь+1}&#34;,&#34;УИД&#34;:&#34;${данныеШаблона.УИД}&#34;,&#34;имяШаблона&#34;:&#34;${данныеШаблона.имяШаблона}&#34;} )' class="button  is-danger control">
            <i class="fas fa-minus p-1"></i>
        </button>
        </div>
    </div>
