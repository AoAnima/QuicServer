...
func Обработать(запрос ConnQuic.Сообщение) ([]byte, error) {
...
func АнализЗапроса(Запрос *ConnQuic.Сообщение) {
	...
	Инфо(" Запрос.Запрос.СтрокаЗапроса %+v \n", Запрос.Запрос.СтрокаЗапроса)
	// if err != nil {
...
func СохранитьЗапрос(запрос *ConnQuic.Сообщение) {
