...
func (т *Таблица) ВставитьДокумент(таблица string, ключ string, объект map[string]interface{}, уникальныйИндекс []string, индексы []string) ОшибкаБазы {
...
func (трз *Транзакция) Записать(ключ string, значение []byte) ОшибкаБазы {
