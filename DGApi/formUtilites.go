...
*/
// func ЗначениеФормы(вариантИмениПоля []string, форма map[string][]string) (string, СтатусСервиса) {
...
func ЗначениеФормы(имяПоля string, форма map[string][]string) (string, СтатусСервиса) {
...
func ВсеЗначенияФормы(имяПоля string, форма map[string][]string) ([]string, СтатусСервиса) {
	значение, есть := форма[имяПоля]
	if есть {
		if len(значение) > 0 {
